...
const stSeqDesc		diag_seq_desc[SEQ_DESC_IDX_MAX] = {
		...
		{TASKID_OM, 1000, 1500, 300, 0, CCW},
		{TASKID_OM, 500, 1700, 300, 0, CW},
		{TASKID_OM, 600, 2000, 300, 0, CCW},
		{TASKID_OM, 700, 500, 300, 0, CW},
		{TASKID_SM4, 300, 300, SMSPEED, SMOOTHON, UP},
		{TASKID_OM, 300, 2000, 300, 0, CW},
		{TASKID_OM, 800, 5750, OMSPEED, 0, CW},
		{TASKID_SM1, 700, VACCUMSTEP, SMSPEED, SMOOTHON, DOWN},
//				{TASKID_SM2, VACCUMDELAY, 3000, SMSPEED, SMOOTHON, DOWN},
		{TASKID_SM2, VACCUMDELAY, 480, 9000, SMOOTHON, UP},
		{TASKID_SM1, 4500, VACCUMSTEP, SMSPEED, SMOOTHON, UP},
//				{TASKID_SM2, VACCUMDELAY, 320, SMSPEED, SMOOTHON, UP},
		{TASKID_OM, 800, 5900, OMSPEED, 0, CCW},

		{TASKID_OM, 3700, 1500, 300, 0, CCW},
		{TASKID_SM4, 600, 300, SMSPEED, SMOOTHON, DOWN},
		{TASKID_OM, 300, 2000, 300, 0, CW},
		{TASKID_OM, 700, 500, 300, 0, CW},
		{TASKID_OM, 300, 500, 300, 0, CCW},
		{TASKID_SM4, 300, MAGNETSTEP, SMSPEED, SMOOTHON, UP},
...
//				{TASKID_SM3, PUMPDELAY, PUMPSTEP, PUMPSPEED, SMOOTHON, UP},
				...
				{TASKID_OM, 1000, 1500, 300, 0, CCW},							/*Pump infuser delay 7sec and Open tube*/
				{TASKID_OM, 500, 1700, 300, 0, CW},
				{TASKID_OM, 600, 2000, 300, 0, CCW},
				{TASKID_OM, 700, 500, 300, 0, CW},

				{TASKID_SM4, 300, 300, SMSPEED, SMOOTHON, UP},
				{TASKID_OM, 500, 1500, 300, 0, CCW},							/*Pump infuser delay 7sec and Open tube*/
				{TASKID_OM, 500, 1700, 300, 0, CW},
				{TASKID_OM, 500, 1500, 300, 0, CCW},							/*Pump infuser delay 7sec and Open tube*/
				{TASKID_OM, 500, 1700, 300, 0, CW},
				{TASKID_OM, 500, 1500, 300, 0, CCW},
				{TASKID_SM4, 500, 300, SMSPEED, SMOOTHON, DOWN},

				{TASKID_OM, 1000, 2000, 300, 0, CW},
				{TASKID_OM, 700, 500, 300, 0, CW},
				{TASKID_OM, 300, 500, 300, 0, CCW},
				{TASKID_SM4, 300, MAGNETSTEP, SMSPEED, SMOOTHON, UP},
#endif
...
//				{TASKID_SM4, 1000, MAGNETSTEP, SMSPEED, SMOOTHON, DOWN},
//				{TASKID_OM, 3500, 1250, 600, 0, CW},
//				{TASKID_OM, 800, 500, 600, 0, CCW},
//				{TASKID_SM4, 400, 300, SMSPEED, SMOOTHON, UP},
//				{TASKID_OM, 500, 1000, 600, 0, CCW},
//				{TASKID_SM4, 1000, 130, SMSPEED, SMOOTHON, DOWN},
//				{TASKID_PEL, 1000, 9000, 600, 0, 1},

				{TASKID_SM4, 1000, 1820, SMSPEED, SMOOTHON, DOWN}, /*bolt no magnet*/ //1950 test zig
				{TASKID_PEL, 1000, 9000, 600, 0, 1},
#endif
...
//Ver2.0
		...
		{TASKID_SM4, 0, 300, SMSPEED, SMOOTHON, UP},
		...
		{TASKID_SM4, 0, 300, SMSPEED, SMOOTHON, DOWN},	//50
		{TASKID_OPT, 0xFFFFFFF0, CHAM_4_1, 1, DIS_CONT, 0},

		/* cycle = 6 */
		{TASKID_OPT, 0xFFFFFFF0, CHAM_4_1, 1, CONTINUE, 0},
		{TASKID_SM4, 0, 300, SMSPEED, SMOOTHON, UP},	//50
		{TASKID_OM, 0xFFFFFFF0, 4500, 200, 0, CW},	// chamber4 -> 3
		{TASKID_OPT, 0xFFFFFFF0, CHAM_3_4, 1, CONTINUE, 0},
		{TASKID_OM, 0xFFFFFFF0, 4500, 200, 0, CW},	// chamber3 -> 2
		{TASKID_OPT, 0xFFFFFFF0, CHAM_2_3, 1, CONTINUE, 0},
		{TASKID_OM, 0xFFFFFFF0, 4500, 200, 0, CW},	// chamber2 -> 1
		{TASKID_SM4, 0, 300, SMSPEED, SMOOTHON, DOWN},
...
//						setPoint = peltier_delayed_SetPoint(g_PRE_COND_SETPOINT, OVERSHOOT_OFFSET, MINUTE_UNIT  * 4); //[4]// SECOND_UNIT*20
						if(peltier_ctrl_pre_cond( g_PRE_COND_SETPOINT, MINUTE_UNIT * g_Keeping_Minute_Peltier_Temperature  ) == TRUE)  //[7] // @@@ setPoint: 사이클 전 precondition 구간 온도 세팅값 변수

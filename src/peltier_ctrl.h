...
// ����ȭ. #define HEAT_SETPOINT		96//104//100//[105]//101.5 //102 //107//104//105//(95.0 + 25.0) 		/* 110d C */ //@@@  ����Ŭ �� 1st step ���� �Լ�
// ����ȭ. #define COOL_SETPOINT 	   60//59.5 //[58]//60//58//57//54//59//63//80  //(60.0 + 15.0)		/* 75d C */
// ����ȭ. #define PRE_COND_SETPOINT	96//98.5//[102]//99.5//98.5//105//HEAT_SETPOINT
...
// ����ȭ. #define ROUTINE_CYCLE_MAX 	40		// @@@ ������ ���� ����Ŭ ������ define ��
...
#define SECOND_UNIT	MILI_SEC_CNT_PER_SEC //(uint32_t)(((float)MILI_SEC_CNT_PER_SEC) * TIME_LOSS_FACTOR_COEFF) //@@@  ����Ŭ �� 1st step ���� �Լ�
#define MINUTE_UNIT	(SECOND_UNIT * 60)		// @@@ MINUTE_UNIT: ����Ŭ �� precondition ���� �����ð� ���ð�
